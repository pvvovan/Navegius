...
public class Orientation
{
    ...
    public Orientation(Context context)
    {
        ...
        m_RotationAngle = 0;
        m_RotationAxis 	= 	new Vector3(0.0f,0.0f,1.0f);
    ...
    {
        //m_Position = Pos;
        m_Position = new Vector3(-Pos.x, -Pos.y, -Pos.z);
    }
...
//        Matrix.multiplyMM(m_OrientationMatrix, 0, TempMatrix, 0, m_ScaleMatrix, 0);
        ...
        // Then Translate object around Axis then Rotate
        Matrix.multiplyMM(m_OrientationMatrix, 0, m_RotationMatrix, 0, m_PositionMatrix, 0);
